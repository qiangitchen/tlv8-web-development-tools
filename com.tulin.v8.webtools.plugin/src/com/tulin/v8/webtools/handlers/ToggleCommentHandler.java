...
//			} else 
			if (editor.getSelectedPage() instanceof HTMLSourceEditor) {
			 ...
			 * else if (page.getActiveEditor() instanceof XMLEditor) { XMLEditor editor =
			 * (XMLEditor) page.getActiveEditor(); toggleComment(editor); }
