...
*/
     ...
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Context#jsToJava(Object, Class)
     */
    ...
    static {
        ...
        Class<?> cl = Kit.classOrNull("com.tulin.v8.webtools.jseditor.rhino.javascript.JavaAdapter");
        if (cl != null) {
            try {
