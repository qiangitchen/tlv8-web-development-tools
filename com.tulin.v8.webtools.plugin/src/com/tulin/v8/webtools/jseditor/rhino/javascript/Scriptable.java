...
public interface Scriptable {
     ...
     * <LI>com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Context#getUndefinedValue
     */
     ...
     * @param start the object in which the lookup began
     * @return the value of the property (may be null), or NOT_FOUND
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(String,Scriptable)
     */
     ...
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(String, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(int, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(String, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @param start the object whose property is being set
     * @param value value to set the property to
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#has(int, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(int, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(String, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable#get(int, Scriptable)
     * @see com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
