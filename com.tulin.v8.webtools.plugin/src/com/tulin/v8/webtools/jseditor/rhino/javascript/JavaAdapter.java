...
public final class JavaAdapter implements IdFunctionCall {
	...
	private static void generateCtor(ClassFileWriter cfw, String adapterName, String superName) {
		...
		cfw.add(ByteCode.ALOAD_0); // this
		cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/JavaAdapter",
	...
	private static void generateEmptyCtor(ClassFileWriter cfw, String adapterName, String superName,
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/JavaAdapter", "runScript",
	...
	static void generateReturnResult(ClassFileWriter cfw, Class<?> retType, boolean callConvertResult) {
		...
		if (retType == Void.TYPE) {
			...
			cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/Context", "toBoolean",
					"(Ljava/lang/Object;)Z");
			...
			cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/Context", "toString",
			...
			cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/Context", "toNumber",
					"(Ljava/lang/Object;)D");
