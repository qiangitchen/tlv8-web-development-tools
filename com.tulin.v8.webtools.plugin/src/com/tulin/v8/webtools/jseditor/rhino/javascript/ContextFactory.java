 ...
 * <pre>
 * import com.tulin.v8.webtools.jseditor.rhino.javascript.*;
 *
...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link com.tulin.v8.webtools.jseditor.rhino.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected com.tulin.v8.webtools.jseditor.rhino.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return com.tulin.v8.webtools.jseditor.rhino.javascript.xml.XMLLib.Factory.create(
                "com.tulin.v8.webtools.jseditor.rhino.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return com.tulin.v8.webtools.jseditor.rhino.javascript.xml.XMLLib.Factory.create(
                "com.tulin.v8.webtools.jseditor.rhino.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
