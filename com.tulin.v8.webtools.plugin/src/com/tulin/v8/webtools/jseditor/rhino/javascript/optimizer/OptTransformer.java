...
import com.tulin.v8.webtools.jseditor.rhino.javascript.NodeTransformer;
...
class OptTransformer extends NodeTransformer {
	...
	private void detectDirectCall(Node node, ScriptOrFnNode tree) {
		if (tree.getType() == Token.FUNCTION) {
			 ...
			 *
			 * // this is a DIRECTCALL node fn = GetProp(tmp = GetBase("a"), "a"); if (fn ==
			 * FunctionObjectFor"a") fn.call(tmp, b, c) else ScriptRuntime.Call(fn, tmp, b,
			 * c)
			 */
