...
package com.tulin.v8.webtools.jseditor.rhino.javascript.optimizer;
...
import com.tulin.v8.webtools.jseditor.rhino.classfile.ByteCode;
import com.tulin.v8.webtools.jseditor.rhino.classfile.ClassFileWriter;
import com.tulin.v8.webtools.jseditor.rhino.javascript.CompilerEnvirons;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Context;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Evaluator;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Function;
import com.tulin.v8.webtools.jseditor.rhino.javascript.FunctionNode;
import com.tulin.v8.webtools.jseditor.rhino.javascript.GeneratedClassLoader;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Kit;
import com.tulin.v8.webtools.jseditor.rhino.javascript.NativeFunction;
import com.tulin.v8.webtools.jseditor.rhino.javascript.NativeGenerator;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Node;
import com.tulin.v8.webtools.jseditor.rhino.javascript.ObjArray;
import com.tulin.v8.webtools.jseditor.rhino.javascript.ObjToIntMap;
import com.tulin.v8.webtools.jseditor.rhino.javascript.RhinoException;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Script;
import com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptOrFnNode;
import com.tulin.v8.webtools.jseditor.rhino.javascript.ScriptRuntime;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Scriptable;
import com.tulin.v8.webtools.jseditor.rhino.javascript.SecurityController;
import com.tulin.v8.webtools.jseditor.rhino.javascript.Token;
...
public class Codegen implements Evaluator {
	...
	public Object compile(CompilerEnvirons compilerEnv, ScriptOrFnNode tree, String encodedSource,
		...
		String mainClassName = "com.tulin.v8.webtools.jseditor.rhino.javascript.gen.c" + serial;
	...
	private RuntimeException reportClassFileFormatException(ScriptOrFnNode scriptOrFn, String message) {
		String msg = scriptOrFn instanceof FunctionNode
				? ScriptRuntime.getMessage2("msg.while.compiling.fn", ((FunctionNode) scriptOrFn).getFunctionName(),
						message)
	...
	private void transform(ScriptOrFnNode tree) {
		...
		if (optLevel > 0) {
			/*
			 * Collect all of the contained functions into a hashtable so that the call
			 * optimizer can access the class name & parameter count for any call it
			 * encounters
			 */
	...
	private byte[] generateCode(String encodedSource) {
		...
		if (hasScript) {
			cfw.addInterface("com.tulin.v8.webtools.jseditor.rhino/javascript/Script");
	...
	private void emitDirectConstructor(ClassFileWriter cfw, OptFunctionNode ofn) {
		 ...
		 * newInstance = createObject(cx, scope); Object val = <body-name>(cx, scope,
		 * newInstance, <directCallArgs>); if (val instanceof Scriptable) { return
		 * (Scriptable) val; } return newInstance; }
		 */
		...
		cfw.addInvoke(ByteCode.INVOKEVIRTUAL, "com.tulin.v8.webtools.jseditor.rhino/javascript/BaseFunction",
				"createObject",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
		...
		cfw.add(ByteCode.INSTANCEOF, "com.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable");
		cfw.add(ByteCode.IFEQ, exitLabel);
		// cast direct call result
		cfw.add(ByteCode.CHECKCAST, "com.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable");
	...
	private void generateResumeGenerator(ClassFileWriter cfw) {
		...
		cfw.startMethod("resumeGenerator",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "ILjava/lang/Object;"
		...
		for (int i = 0; i < scriptOrFnNodes.length; i++) {
			...
			if (isGenerator(n)) {
				String type = "(" + mainClassSignature + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "Ljava/lang/Object;"
	...
	private void generateCallMethod(ClassFileWriter cfw) {
		...
		cfw.addALoad(1); // cx
		cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/ScriptRuntime",
				"hasTopCall", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Z");
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/ScriptRuntime",
				"doTopCall",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Callable;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "[Ljava/lang/Object;"
						+ ")Ljava/lang/Object;");
	...
	private void generateMain(ClassFileWriter cfw) {
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC, mainMethodClass, "main",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Script;[Ljava/lang/String;)V");
	...
	private void generateFunctionConstructor(ClassFileWriter cfw) {
		...
		for (int i = start; i != end; ++i) {
			...
			cfw.addInvoke(ByteCode.INVOKEVIRTUAL, mainClassName, getFunctionInitMethodName(ofn),
	...
	private void generateFunctionInit(ClassFileWriter cfw, OptFunctionNode ofn) {
		...
		cfw.addALoad(CONTEXT_ARG);
		cfw.addALoad(SCOPE_ARG);
		cfw.addInvoke(ByteCode.INVOKEVIRTUAL, "com.tulin.v8.webtools.jseditor.rhino/javascript/NativeFunction",
				"initScriptFunction", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
	...
	private void emitRegExpInit(ClassFileWriter cfw) {
		...
		for (int i = 0; i != scriptOrFnNodes.length; ++i) {
			...
			for (int j = 0; j != regCount; ++j) {
				...
				cfw.addInvoke(ByteCode.INVOKEINTERFACE, "com.tulin.v8.webtools.jseditor.rhino/javascript/RegExpProxy",
						"compileRegExp", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
	...
	void pushRegExpArray(ClassFileWriter cfw, ScriptOrFnNode n, int contextArg, int scopeArg) {
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/ScriptRuntime",
				"checkRegExpProxy", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/RegExpProxy;");
		// Stack: proxy, array
		cfw.add(ByteCode.DUP);
		cfw.addALoad(contextArg);
	...
	void pushNumberAsObject(ClassFileWriter cfw, double num) {
		if (num == 0.0) {
			if (1 / num > 0) {
				// +0.0
				cfw.add(ByteCode.GETSTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/optimizer/OptRuntime",
			...
			cfw.add(ByteCode.GETSTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/ScriptRuntime", "NaNobj",
					"Ljava/lang/Double;");
	...
	private static void addDoubleWrap(ClassFileWriter cfw) {
		cfw.addInvoke(ByteCode.INVOKESTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/optimizer/OptRuntime",
	...
	static void pushUndefined(ClassFileWriter cfw) {
		cfw.add(ByteCode.GETSTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/Undefined", "instance",
				"Ljava/lang/Object;");
	}
	...
	String getBodyMethodSignature(ScriptOrFnNode n) {
		...
		sb.append("Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
				+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
				+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
		if (n.getType() == Token.FUNCTION) {
			OptFunctionNode ofn = OptFunctionNode.get(n);
	...
	static final String DEFAULT_MAIN_METHOD_CLASS = "com.tulin.v8.webtools.jseditor.rhino.javascript.optimizer.OptRuntime";

	private static final String SUPER_CLASS_NAME = "com.tulin.v8.webtools.jseditor.rhino.javascript.NativeFunction";

	static final String DIRECT_CALL_PARENT_FIELD = "_dcp";
	private static final String ID_FIELD_NAME = "_id";

	private static final String REGEXP_INIT_METHOD_NAME = "_reInit";
	private static final String REGEXP_INIT_METHOD_SIGNATURE = "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/RegExpProxy;"
			+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")V";
	static final String REGEXP_ARRAY_FIELD_NAME = "_re";
	static final String REGEXP_ARRAY_FIELD_TYPE = "[Ljava/lang/Object;";

	static final String FUNCTION_INIT_SIGNATURE = "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
			+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + ")V";

	static final String FUNCTION_CONSTRUCTOR_SIGNATURE = "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
			+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;I)V";
...
class BodyCodegen {
	void generateBodyCode() {
		...
		if (isGenerator) {
			...
			String type = "(" + codegen.mainClassSignature + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "Ljava/lang/Object;"
					+ "Ljava/lang/Object;I)Ljava/lang/Object;";
	...
	private void generateGenerator() {
		...
		if (fnCurrent != null && !inDirectCallFunction
			...
			cfw.addInvoke(ByteCode.INVOKEINTERFACE, "com.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable",
					"getParentScope", "()Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
		...
		addScriptRuntimeInvoke("createFunctionActivation",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/NativeFunction;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "[Ljava/lang/Object;"
						+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
		cfw.addAStore(variableObjectLocal);
		...
		addOptRuntimeInvoke("createNativeGenerator",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/NativeFunction;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;II"
						+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
	...
	private void generatePrologue() {
		...
		if (fnCurrent != null) {
			...
			addScriptRuntimeInvoke("initScript",
					"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/NativeFunction;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "Z" + ")V");
		}
		...
		if (compilerEnv.isGenerateDebugInfo()) {
			cfw.addVariableDescriptor(debugVariableName, "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;",
		...
		if (fnCurrent == null) {
			...
			if (fnCurrent.itsContainsCalls0) {
				...
				cfw.add(ByteCode.GETSTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/ScriptRuntime",
	...
	private void generateEpilogue() {
		...
		if (hasVarsInRegs) {
			...
			// mark the handler
			cfw.addExceptionHandler(enterAreaStartLabel, epilogueLabel, finallyHandler, null); // catch any
		}
	}
	...
	private void generateStatement(Node node) {
		...
		case Token.CATCH_SCOPE: {
			...
			addScriptRuntimeInvoke("newCatchScope",
					"(Ljava/lang/Throwable;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
							+ "Ljava/lang/String;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
							+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
			cfw.addAStore(local);
		}
		...
		case Token.ENTERWITH:
			...
			addScriptRuntimeInvoke("enterWith",
					"(Ljava/lang/Object;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
							+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
			cfw.addAStore(variableObjectLocal);
		...
		case Token.LEAVEWITH:
			cfw.addALoad(variableObjectLocal);
			addScriptRuntimeInvoke("leaveWith", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
					+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
			cfw.addAStore(variableObjectLocal);
		...
		case Token.ENUM_INIT_ARRAY:
			...
			int enumType = type == Token.ENUM_INIT_KEYS ? ScriptRuntime.ENUMERATE_KEYS
					: type == Token.ENUM_INIT_VALUES ? ScriptRuntime.ENUMERATE_VALUES : ScriptRuntime.ENUMERATE_ARRAY;
			cfw.addPush(enumType);
			addScriptRuntimeInvoke("enumInit", "(Ljava/lang/Object;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + "I" + ")Ljava/lang/Object;");
	...
	private void generateThrowJavaScriptException() {
		cfw.add(ByteCode.NEW, "com.tulin.v8.webtools.jseditor.rhino/javascript/JavaScriptException");
		cfw.add(ByteCode.DUP_X1);
		cfw.add(ByteCode.SWAP);
		cfw.addPush(scriptOrFn.getSourceName());
		cfw.addPush(itsLineNumber);
		cfw.addInvoke(ByteCode.INVOKESPECIAL, "com.tulin.v8.webtools.jseditor.rhino/javascript/JavaScriptException",
	...
	private void generateExpression(Node node, Node parent) {
		...
		case Token.NAME: {
			...
			addScriptRuntimeInvoke("name",
					"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "Ljava/lang/String;"
							+ ")Ljava/lang/Object;");
		}
			break;
		...
		case Token.REF_CALL:
			...
			addScriptRuntimeInvoke("callRef",
					"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Callable;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "[Ljava/lang/Object;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
							+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;");
			break;
		...
		case Token.ENUM_ID: {
			...
			if (type == Token.ENUM_NEXT) {
				...
				addScriptRuntimeInvoke("enumId", "(Ljava/lang/Object;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Ljava/lang/Object;");
			}
			break;
		}
		...
		case Token.GET_REF:
			...
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke("refGet", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Ljava/lang/Object;");
			break;
		...
		case Token.SET_REF_OP: {
			...
			addScriptRuntimeInvoke("refSet",
					"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;" + "Ljava/lang/Object;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Ljava/lang/Object;");
		}
			break;
		...
		case Token.DEL_REF:
			generateExpression(child, node);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke("refDel", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Ljava/lang/Object;");
			break;
		...
		case Token.REF_NS_NAME: {
			...
			case Token.REF_MEMBER:
				...
				signature = "(Ljava/lang/Object;" + "Ljava/lang/Object;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + "I"
						+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;";
				break;
			case Token.REF_NS_MEMBER:
				methodName = "memberRef";
			...
			case Token.REF_NAME:
				methodName = "nameRef";
				signature = "(Ljava/lang/Object;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "I"
						+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;";
				cfw.addALoad(variableObjectLocal);
				break;
			case Token.REF_NS_NAME:
		...
		case Token.ESCXMLATTR:
			...
			addScriptRuntimeInvoke("escapeAttributeValue", "(Ljava/lang/Object;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Ljava/lang/String;");
			break;
	...
	private void visitFunction(OptFunctionNode ofn, int functionType) {
		...
		addOptRuntimeInvoke("initFunction",
				"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/NativeFunction;" + "I"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")V");
	}
	...
	private void visitSpecialCall(Node node, int type, int specialType, Node child) {
		...
		if (type == Token.NEW) {
			...
			callSignature = "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + "Ljava/lang/Object;"
					+ "[Ljava/lang/Object;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "I" // call type
					+ ")Ljava/lang/Object;";
			cfw.addALoad(variableObjectLocal);
			cfw.addALoad(thisObjLocal);
			...
			callSignature = "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Callable;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "[Ljava/lang/Object;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "I" // call type
	...
	private void visitStandardCall(Node node, Node child) {
		...
		if (firstArgChild == null) {
			if (childType == Token.NAME) {
				...
				signature = "(Ljava/lang/String;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + ")Ljava/lang/Object;";
				...
				generateFunctionAndThisObj(child, node);
				methodName = "call0";
				signature = "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Callable;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
						+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + ")Ljava/lang/Object;";
			}
	...
	private void visitOptimizedCall(Node node, OptFunctionNode target, int type, Node child) {
		...
		/*
		 * Remember that directCall parameters are paired in 1 aReg and 1 dReg If the
		 * argument is an incoming arg, just pass the orginal pair thru. Else, if the
		 * argument is known to be typed 'Number', pass Void.TYPE in the aReg and the
		 * number is the dReg Else pass the JS object in the aReg and 0.0 in the dReg.
		 */
		...
		cfw.add(ByteCode.GETSTATIC, "com.tulin.v8.webtools.jseditor.rhino/javascript/ScriptRuntime", "emptyArgs",
				"[Ljava/lang/Object;");
		...
		if (type == Token.NEW) {
			...
			cfw.addInvoke(ByteCode.INVOKEINTERFACE, "com.tulin.v8.webtools.jseditor.rhino/javascript/Callable", "call",
					"(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
							+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + "[Ljava/lang/Object;"
							+ ")Ljava/lang/Object;");
	...
	private void generateFunctionAndThisObj(Node node, Node parent) {
		...
		cfw.addALoad(contextLocal);
		addScriptRuntimeInvoke("lastStoredScriptable", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;"
				+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
	}
	...
	private void visitTryCatchFinally(Node.Jump node, Node child) {
		/*
		 * Save the variable object, in case there are with statements enclosed by the
		 * try block and we catch some exception. We'll restore it for the catch block
		 * so that catch block statements get the right scope.
		 */
		 ...
		 * NodeTransformer; Codegen just adds the java handlers for the javascript catch
		 * and finally clauses.
		 */
		...
		if (catchTarget != null) {
			...
			/*
			 * we also need to catch EcmaErrors and feed the associated error object to the
			 * handler
			 */
	...
	private void generateCatchBlock(int exceptionType, short savedVariableObject, int catchLabel, int startLabel,
		...
		if (exceptionType == JAVASCRIPT_EXCEPTION) {
			exceptionName = "com.tulin.v8.webtools.jseditor.rhino/javascript/JavaScriptException";
		} else if (exceptionType == EVALUATOR_EXCEPTION) {
			exceptionName = "com.tulin.v8.webtools.jseditor.rhino/javascript/EvaluatorException";
		} else if (exceptionType == ECMAERROR_EXCEPTION) {
			exceptionName = "com.tulin.v8.webtools.jseditor.rhino/javascript/EcmaError";
	...
	private void visitTypeofname(Node node) {
		...
		cfw.addALoad(variableObjectLocal);
		cfw.addPush(node.getString());
		addScriptRuntimeInvoke("typeofName", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
	...
	/**
	 * Generate calls to ScriptRuntime.addInstructionCount to keep track of executed
	 * instructions and call <code>observeInstructionCount()</code> if a threshold
	 * is exceeded.<br>
	...
	private void visitIncDec(Node node) {
		...
		case Token.GET_REF: {
			...
			cfw.addALoad(contextLocal);
			cfw.addPush(incrDecrMask);
			addScriptRuntimeInvoke("refIncrDecr", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Ref;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + "I)Ljava/lang/Object;");
			break;
		}
		default:
	...
	private void visitIfJumpRelOp(Node node, Node child, int trueGOTO, int falseGOTO) {
		...
		if (type == Token.INSTANCEOF || type == Token.IN) {
			...
			addScriptRuntimeInvoke((type == Token.INSTANCEOF) ? "instanceOf" : "in", "(Ljava/lang/Object;"
					+ "Ljava/lang/Object;" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Z");
	...
	private void visitGetProp(Node node, Node child) {
		...
		if (node.getType() == Token.GETPROPNOWARN) {
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke("getObjectPropNoWarn", "(Ljava/lang/Object;" + "Ljava/lang/String;"
					+ "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Context;" + ")Ljava/lang/Object;");
			return;
		}
		/*
	...
	private void visitDotQuery(Node node, Node child) {
		...
		addScriptRuntimeInvoke("updateDotQuery",
				"(Z" + "Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;" + ")Ljava/lang/Object;");
		cfw.add(ByteCode.DUP);
		cfw.add(ByteCode.IFNULL, queryLoopStart);
		// stack: ... non_null_result_of_updateDotQuery
		cfw.addALoad(variableObjectLocal);
		addScriptRuntimeInvoke("leaveDotQuery", "(Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;"
				+ ")Lcom.tulin.v8.webtools.jseditor.rhino/javascript/Scriptable;");
		cfw.addAStore(variableObjectLocal);
	}
