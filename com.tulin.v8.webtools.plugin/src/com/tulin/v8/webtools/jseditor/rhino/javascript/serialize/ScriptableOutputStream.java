...
package com.tulin.v8.webtools.jseditor.rhino.javascript.serialize;
...
import com.tulin.v8.webtools.jseditor.rhino.javascript.UniqueTag;
...
public class ScriptableOutputStream extends ObjectOutputStream {
	...
	/**
	 * ScriptableOutputStream constructor. Creates a ScriptableOutputStream for use
	 * in serializing JavaScript objects. Calls excludeStandardObjectNames.
	 *
	 ...
	 * 
	 * @param name a fully qualified name (of the form "a.b.c", where "a" must be a
	 ...
	 * @throws IllegalArgumentException if the object is not found or is not a
	 *                                  {@link Scriptable}.
	 */
