...
class Block {
	...
	private static void reachingDefDataFlow(OptFunctionNode fn, Node[] statementNodes, Block theBlocks[],
		 ...
		 * any block whose inputs change as a result of the dataflow. REMIND, better
		 * would be to visit in CFG postorder
		 */
	...
	/*
	 * We're tracking uses and defs - in order to build the def set and to identify
	 * the last use nodes.
	 * 
	...
	/*
	 * build the live on entry/exit sets. Then walk the trees looking for defs/uses
	 * of variables and build the def and useBeforeDef sets.
	 */
