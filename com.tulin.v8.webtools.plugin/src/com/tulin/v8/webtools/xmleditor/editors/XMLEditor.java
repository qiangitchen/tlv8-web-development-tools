	...
	public String[] getClassNameAttributes() {
		if (classNameAttributes == null) {
			...
			if (store.getBoolean(HTMLPlugin.PREF_ENABLE_CLASSNAME)) {
				classNameAttributes = StringConverter.asArray(store.getString(HTMLPlugin.PREF_CLASSNAME_ATTRS));
			} else {
...
//					parser.parse(new InputSource(new StringReader(xml))); 
	...
	protected void addContextMenuActions(IMenuManager menu) {
		menu.appendToGroup(ITextEditorActionConstants.GROUP_EDIT,
				new MenuManager(HTMLPlugin.getResourceString("HTMLEditorPreferencePage.XML"), GROUP_HTML));
		menu.appendToGroup(ITextEditorActionConstants.GROUP_EDIT,
		...
		addAction(menu, HTMLPlugin.GROUP_SOURCE, ACTION_FORMAT_XML);
