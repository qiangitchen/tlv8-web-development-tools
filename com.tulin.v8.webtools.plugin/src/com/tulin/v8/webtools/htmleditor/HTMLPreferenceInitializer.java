...
import com.tulin.v8.webtools.htmleditor.editors.IHTMLColorConstants;
...
public class HTMLPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		store.setDefault(HTMLPlugin.PREF_COLOR_ATTR, StringConverter.asString(IHTMLColorConstants.ATTR));
		store.setDefault(HTMLPlugin.PREF_COLOR_VALUE, StringConverter.asString(IHTMLColorConstants.VALUE));
	...
	private void getContributions(IPreferenceStore store) {
		try {
			...
			IExtensionPoint point = registry.getExtensionPoint(HTMLPlugin.getPluginId() + ".preferenceContributer");
