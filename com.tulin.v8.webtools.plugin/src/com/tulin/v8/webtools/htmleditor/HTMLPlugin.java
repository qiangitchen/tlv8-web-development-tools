...
import com.tulin.v8.webtools.htmleditor.views.IPaletteContributer;
import com.tulin.v8.webtools.jseditor.launch.ClosureCompilerLaunchUtil;
import com.tulin.v8.webtools.jseditor.launch.JavaScriptLaunchUtil;
import com.tulin.v8.webtools.jspeditor.editors.IJSPELAssistProcessor;
import com.tulin.v8.webtools.jspeditor.editors.IJSPFilter;
import com.tulin.v8.webtools.jspeditor.editors.ITLDLocator;
...
//		innerTLD.put("http://java.sun.com/jsp/jstl/functions","/TLD/fn.tld");
	...
	public HTMLPlugin() {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("com.tulin.v8.webtools.htmleditor.HTMLPluginResources");
