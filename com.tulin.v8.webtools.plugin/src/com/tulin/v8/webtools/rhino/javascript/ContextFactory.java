...
public class ContextFactory
{
     ...
     */
    protected com.tulin.v8.webtools.rhino.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return com.tulin.v8.webtools.rhino.javascript.xml.XMLLib.Factory.create(
                "com.tulin.v8.webtools.rhino.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return com.tulin.v8.webtools.rhino.javascript.xml.XMLLib.Factory.create(
                "com.tulin.v8.webtools.rhino.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
