...
public class ContentAssistProcessorRegistry {
	...
	private static final String EXTENSION_POINT_ID = WebToolsPlugin.BUNDLE_ID + ".contentAssistProcessors"; //$NON-NLS-1$
			...
			if (!this.extensions.containsKey(extension)) {
				try {
					...
					WebToolsPlugin.getDefault().getLog()
							.log(new Status(IStatus.ERROR, WebToolsPlugin.BUNDLE_ID, ex.getMessage(), ex));
				}
			}
		}
