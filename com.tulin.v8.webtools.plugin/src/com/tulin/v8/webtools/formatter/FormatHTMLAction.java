...
public class FormatHTMLAction extends Action {
	...
	public void run() {
		...
		int prefIndent = store.getInt(WebToolsPlugin.PREF_FORMATTER_INDENT);
		boolean prefUseTab = store.getBoolean(WebToolsPlugin.PREF_FORMATTER_TAB);
		int lineChars = store.getInt(WebToolsPlugin.PREF_FORMATTER_LINE);
