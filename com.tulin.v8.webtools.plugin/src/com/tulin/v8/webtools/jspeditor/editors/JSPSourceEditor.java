...
import com.tulin.v8.webtools.htmleditor.editors.IHTMLOutlinePage;
...
//	}
	...
	protected void addContextMenuActions(IMenuManager menu) {
		menu.appendToGroup(ITextEditorActionConstants.GROUP_EDIT,
				new MenuManager(HTMLPlugin.getResourceString("HTMLEditorPreferencePage.JSP"), GROUP_HTML));
		menu.appendToGroup(ITextEditorActionConstants.GROUP_EDIT,
		...
		addAction(menu, HTMLPlugin.GROUP_SOURCE, ACTION_ESCAPE_HTML);
		addAction(menu, HTMLPlugin.GROUP_SOURCE, ACTION_COMMENT);
		addAction(menu, HTMLPlugin.GROUP_SOURCE, ACTION_JSP_COMMENT);
