...
import com.tulin.v8.webtools.htmleditor.IHyperlinkProvider;
import com.tulin.v8.webtools.htmleditor.assist.HTMLAssistProcessor;
import com.tulin.v8.webtools.htmleditor.editors.HTMLAutoEditStrategy;
...
public class JSPConfiguration extends HTMLConfiguration {
	...
	protected RuleBasedScanner getScriptScanner() {
		if (scriptletScanner == null) {
			...
			scriptletScanner.setDefaultReturnToken(getColorProvider().getToken(HTMLPlugin.PREF_COLOR_FG));
		}
	...
	protected RuleBasedScanner getDirectiveScanner() {
		if (directiveScanner == null) {
			...
			directiveScanner.setDefaultReturnToken(getColorProvider().getToken(HTMLPlugin.PREF_COLOR_TAG));
		}
	...
	protected HTMLTagScanner getPrefixTagScanner() {
		if (prefixTagScanner == null) {
			...
			prefixTagScanner.setDefaultReturnToken(getColorProvider().getToken(HTMLPlugin.PREF_COLOR_TAGLIB));
		}
