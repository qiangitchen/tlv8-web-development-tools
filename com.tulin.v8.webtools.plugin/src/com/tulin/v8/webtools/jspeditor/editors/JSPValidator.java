...
import com.tulin.v8.webtools.htmleditor.ICustomTagValidator;
import com.tulin.v8.webtools.htmleditor.ICustomTagValidatorContributer;
import com.tulin.v8.webtools.htmleditor.assist.AttributeInfo;
import com.tulin.v8.webtools.htmleditor.assist.TagInfo;
import com.tulin.v8.webtools.htmleditor.editors.HTMLValidator;
...
//				String tagName = dim[1];
				...
				if (uri != null) {
					ICustomTagValidatorContributer contributer = HTMLPlugin.getDefault()
