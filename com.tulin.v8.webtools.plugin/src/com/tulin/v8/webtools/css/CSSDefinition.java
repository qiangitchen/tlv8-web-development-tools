...
public class CSSDefinition {
	...
	public static final CSSValue[] CSS_VALUES = {
			...
			new CSSValue("letter-spacing:", new CSSInfo[] {new CSSInfo("normal",""),new CSSInfo("length",""),new CSSInfo("inherit","")}),
			new CSSValue("word-spacing:", new CSSInfo[] {new CSSInfo("normal",""),new CSSInfo("length",""),new CSSInfo("inherit","")}),
			new CSSValue("text-transform:", new CSSInfo[] {new CSSInfo("none",""),new CSSInfo("capitalize",""),new CSSInfo("uppercase",""),new CSSInfo("lowercase",""),new CSSInfo("inherit","")}),
